    ...
    render() {
        ...
        if(track===undefined||lyrics===undefined||Object.keys(track).length===0||Object.keys(lyrics).length===0){
           return <Spinner />
            ...
            return (
                <React.Fragment>
                    <Link to="/musiclyrics" className="btn btn-dark btn-sm mb-4" >Go Back</Link>
                    <div className="card">
                    ...
                    <ul className="list-group mt-3">
                        ...
                        <li className="list-group-item">
                            <strong>Song Genre</strong>:{' '}{track.primary_genres.music_genre_list.length!==0?track.primary_genres.music_genre_list[0].music_genre
                        ...
                        <li className="list-group-item">
                            <strong>Album ID</strong>:{' '}<Moment format="DD/MM/YYYY">{track.first_release_date}</Moment>
                        </li>
                    </ul>
                </React.Fragment>
            )
